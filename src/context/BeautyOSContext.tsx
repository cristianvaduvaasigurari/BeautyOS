...
export const INGREDIENTS_CATALOG: Ingredient[] = [
  { id: "1", name: "Hyaluronic Acid", description: "Humectant that draws water into the skin.", benefits: ["Hydration", "Plumping"], hazardScore: 1, comedogenicRating: 0 },
  ...
  { id: "3", name: "Salicylic Acid (BHA)", description: "Oil-soluble exfoliant that deep cleanses pores.", benefits: ["Clear Skin", "Oil Control"], hazardScore: 2, comedogenicRating: 0 },
  { id: "4", name: "Retinol (Vitamin A)", description: "Accelerates cell turnover, stimulates collagen.", benefits: ["Anti-Aging", "Texture"], hazardScore: 9, comedogenicRating: 2 },
  { id: "5", name: "Vitamin C (L-Ascorbic Acid)", description: "Antioxidant that boosts glow and fades hyperpigmentation.", benefits: ["Brightening", "Anti-Aging"], hazardScore: 1, comedogenicRating: 0 },
  { id: "6", name: "Ceramides", description: "Lipids that make up the skin barrier.", benefits: ["Barrier Repair", "Hydration"], hazardScore: 1, comedogenicRating: 0 },
  { id: "7", name: "Zinc PCA", description: "Mineral that regulates sebum production.", benefits: ["Clear Skin", "Oil Control"], hazardScore: 1, comedogenicRating: 0 },
  { id: "8", name: "Centella Soothing (Cica)", description: "Botanical extract known for its powerful healing properties.", benefits: ["Barrier Repair", "Anti-Irritation"], hazardScore: 1, comedogenicRating: 0 },
];

export const PRODUCTS_CATALOG: Product[] = [
  { id: "p1", brand: "CeraVe", name: "Hydrating Cleanser", category: "Cleanser", ingredients: ["Ceramides", "Hyaluronic Acid"], description: "Face wash designed to cleanse and refresh skin.", paoMonths: 12 },
  { id: "p2", brand: "The Ordinary", name: "Niacinamide 10% + Zinc 1%", category: "Serum", ingredients: ["Niacinamide (Vitamin B3)", "Zinc PCA"], description: "Congestion and sebum reduction formula.", paoMonths: 12 },
  { id: "p3", brand: "La Roche-Posay", name: "Anthelios SPF 50+", category: "Sunscreen", ingredients: ["Centella Soothing (Cica)"], description: "Daily sunscreen providing broad-spectrum protection.", paoMonths: 12 },
  { id: "p4", brand: "Paula's Choice", name: "2% BHA Liquid Exfoliant", category: "Treatment", ingredients: ["Salicylic Acid (BHA)"], description: "Leave-on exfoliant that cleanses inside pores.", paoMonths: 12 },
  { id: "p5", brand: "SkinCeuticals", name: "C E Ferulic", category: "Serum", ingredients: ["Vitamin C (L-Ascorbic Acid)", "Hyaluronic Acid"], description: "Daytime Vitamin C antioxidant serum.", paoMonths: 6 },
  { id: "p6", brand: "Shani Darden", name: "Retinol Reform", category: "Treatment", ingredients: ["Retinol (Vitamin A)", "Hyaluronic Acid"], description: "Gentle time-release Retinol serum.", paoMonths: 12 },
];
