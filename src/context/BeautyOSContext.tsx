...
export const PRODUCTS_CATALOG: Product[] = [
  ...
  { id: "p10", brand: "Dyson Beauty", name: "Airwrap Multi-Styler Complete Long", category: "Treatment", ingredients: ["Coanda Airflow Technology"], description: "Engineered for multiple hair types using aerodynamic Coanda air styling.", paoMonths: 36 },
  { id: "p11", brand: "Olaplex", name: "No.3 Hair Perfector Repair Treatment", category: "Treatment", ingredients: ["Bis-Aminopropyl Diglycol Dimaleate"], description: "Patented bond builder repairing disulfid hair bonds damaged by color or heat.", paoMonths: 12 },
  { id: "p12", brand: "K18", name: "Leave-In Molecular Repair Hair Mask", category: "Treatment", ingredients: ["K18Peptide™"], description: "Clinically proven peptide mask reversing hair damage in 4 minutes.", paoMonths: 12 },
  { id: "p13", brand: "Kérastase", name: "Elixir Ultime L'Huile Original Hair Oil", category: "Treatment", ingredients: ["Marula Oil", "Camellia Oil"], description: "Iconic hair oil delivering ultimate shine and thermal protection.", paoMonths: 18 },
  { id: "p14", brand: "Augustinus Bader", name: "The Rich Cream", category: "Moisturizer", ingredients: ["TFC8® Trigger Factor Complex", "Argan Oil"], description: "Intensely luxurious cream powered by cell-renewing TFC8® technology.", paoMonths: 12 },
  { id: "p15", brand: "SK-II", name: "Facial Treatment Essence", category: "Toner", ingredients: ["PITERA™ Galactomyces Ferment"], description: "Miracle water formula containing 90% PITERA™ for crystal clear skin.", paoMonths: 12 },
