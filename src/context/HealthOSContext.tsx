...
export const INGREDIENTS_CATALOG: Ingredient[] = [
  ...
  { id: "14", name: "Ashwagandha KSM-66", description: "Full-spectrum root extract evaluated in research for supporting cortisol balance and stress response.", benefits: ["Stress Reduction", "Hormonal Balance"], hazardScore: 1, comedogenicRating: 0 },
  { id: "15", name: "Azelaic Acid 10-15%", description: "Dicarboxylic acid evaluated for supporting redness reduction, acne-prone skin, and post-inflammatory hyperpigmentation.", benefits: ["Redness Relief", "Pigmentation Fading"], hazardScore: 1, comedogenicRating: 0 },
